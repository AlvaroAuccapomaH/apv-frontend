...
const NuevoPassword = () => {
    ...
    return (
        <>
            <div>
                <h1 className="text-indigo-600 font-black text-6xl">Reestable tu password y no Pierdas Acceso a{""}
                        ...
                        <>
                            <form onSubmit={handleSubmit}>
                                <div className="my-5">
                                    ...
                                    <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Tu Nuevo Password" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" />
                                </div>
